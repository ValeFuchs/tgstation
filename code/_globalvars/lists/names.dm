...
GLOBAL_LIST_INIT(fox_names_male, world.file2list("strings/names/first_male.txt"))
GLOBAL_LIST_INIT(fox_names_female, world.file2list("strings/names/first_female.txt"))
